---
title: "Week 5 - Multiple Regression 1"
author: "Your Name"
date: "`r Sys.Date()`"
...
This week we learn how conduct correlation test and multple linear regression in `R`.
...
# Data
Let's start by loading your dataset for *this week tutorial*.
...
* **R2** is $R^2$ and **Adj R2** is adjusted $R^2$
* The last three rows are cohen's $f^2$ effect sizes for each individual 
