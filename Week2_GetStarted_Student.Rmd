...
codes, and outputs. R markdowns can be knitted into html files which are 
easier to follow compared to an R script (e.g., `Week2_GetStarted.R`).

Use the `.Rmd` files during the workshops to follow along and practise coding, and read `.html` files 
...
```{r}
# example for Macs
d <- read.csv("/Users/florale/Library/CloudStorage/OneDrive-MonashUniversity/Work/MonashTA/2022_PSY3062/PSY3062 dataset.csv")
...
# but with an additional argument telling it we want 2 decimal points
...
2. Can you calculate the sum of `x` variable too? What do you get?
...
I will add you to the PSY3062 team on DataCamp. 
Michelle and I will add new chapters/exercises that you can practise coding in your own time. 
If you are interested in learning a particular aspect of R or an analysis, 
let me know and I will try to find a chapter for you to practise.
