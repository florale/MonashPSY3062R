---
title: "Week 7 - Moderated Regression"
date: "`r Sys.Date()`"
output: 
  html_document:
    theme: sandstone
...
## Data management
We should make sure our variables have correct data type before runningt the analysis
...
**Exercise**
Check descriptive stastics using the `egltable()`. 
...
**You Try It**
Run a moderated regression model to test whether 
...
but not Sex and Age in model 1 and 2, respectively. We can interpret these results just like how we 
...
visreg(mod2, 
  ...
  scale_color_manual(labels = c("-1" = "18.5", "1" = "26.8"), values = c("yellow", "blue"))
...
at low (M - 1SD) and high (M + 1 SD) levels of age. 
