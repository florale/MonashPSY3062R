...
**Interpreting R Plot**
Normality of Residuals Assumption is met when the data points observations fall along the diagonal straight line.
...
We learnt how to inspect univariate outliers during week 4. 
...
In this case, I would be inclined to remove ID 101, possibly 277 and 377 as outliers.
